...
export function makeShopStyles(t) {
  return {
    ...
    navTabActive: { color: t.text, borderBottom: `2px solid ${t.accent}`, background: `${t.accent}08` },
    navBadge: {
    ...
    tile: { background: t.surface, border: `1px solid ${t.surfaceBorder}`, borderRadius: 10, overflow: 'hidden', cursor: 'pointer', transition: 'border-color 0.2s, box-shadow 0.2s, transform 0.2s' },
