...
export const QUESTIONS = [
  {
    ...
    answers: [
      ...
      { id: 'q1b', label: 'Warm golden glow',         photo: null, gradient: 'linear-gradient(135deg, #fde8b0 0%, #c87820 100%)', scores: { 'Golden Hour': 3, 'Greenhouse': 1, 'Candlelit Cozy Evening': 1 } },
      ...
      { id: 'q1d', label: 'Moody candlelit warmth',    photo: null, gradient: 'linear-gradient(135deg, #100806 0%, #e09828 60%, #281008 100%)', scores: { 'Candlelit Cozy Evening': 3, 'Dark Academia': 2, 'Vivid Sunset': 2 } },
      ...
      { id: 'q1f', label: 'Soft dreamy haze',          photo: null, gradient: 'linear-gradient(135deg, #ede9ff 0%, #7a48cc 100%)', scores: { 'Dream State': 3, 'Blush Hour': 2 } },
    ],
  },
  {
    id: 'q2',
    ...
    answers: [
      { id: 'q2a', label: 'Warm amber and gold',       photo: null, gradient: 'linear-gradient(135deg, #fda020 0%, #c87820 100%)', scores: { 'Golden Hour': 2, 'Vivid Sunset': 1, 'Candlelit Cozy Evening': 2, 'Dark Academia': 1 } },
      ...
      { id: 'q2d', label: 'Blush and soft pastels',     photo: null, gradient: 'linear-gradient(135deg, #fde8e4 0%, #c06858 100%)', scores: { 'Blush Hour': 3, 'Dream State': 2 } },
      ...
      { id: 'q2f', label: 'Earthy green and wood',      photo: null, gradient: 'linear-gradient(135deg, #c8e8c0 0%, #389848 100%)', scores: { 'Greenhouse': 3, 'Blush Hour': 1, 'Bright Day': 1 } },
    ],
  },
  {
    id: 'q3',
    ...
    answers: [
      ...
      { id: 'q3c', label: 'Warm and cradled',            photo: null, gradient: 'linear-gradient(135deg, #201008 0%, #d4882a 100%)', scores: { 'Vivid Sunset': 3, 'Candlelit Cozy Evening': 2, 'Blush Hour': 1 } },
      ...
      { id: 'q3e', label: 'Magical and dreamy',          photo: null, gradient: 'linear-gradient(135deg, #ede9ff 0%, #7a48cc 100%)', scores: { 'Dream State': 3, 'Blush Hour': 1, 'Neon Nights': 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'q4b', label: 'Dark wood shelves, vintage maps, leather',    photo: null, gradient: 'linear-gradient(135deg, #0a0804 0%, #b88828 100%)', scores: { 'Dark Academia': 3, 'Vivid Sunset': 1 } },
      { id: 'q4c', label: 'Wildflowers, linen curtains, terracotta',     photo: null, gradient: 'linear-gradient(135deg, #fde8e0 0%, #c06858 80%, #389848 100%)', scores: { 'Blush Hour': 3, 'Greenhouse': 2 } },
      ...
      { id: 'q4e', label: 'Fairy lights, crystals, flowing fabric',      photo: null, gradient: 'linear-gradient(135deg, #ede9ff 0%, #c8b8f8 50%, #fde8ff 100%)', scores: { 'Dream State': 2, 'Blush Hour': 1, 'Moonlight': 1 } },
  ...
  },
  {
    ...
    answers: [
      { id: 'q5a', label: 'Dawn, first light',            photo: null, gradient: 'linear-gradient(135deg, #fde8e4 0%, #c06858 100%)', scores: { 'Bright Day': 2, 'Blush Hour': 3 } },
      { id: 'q5b', label: 'Golden hour, warm dusk',        photo: null, gradient: 'linear-gradient(135deg, #fda020 0%, #c87820 100%)', scores: { 'Golden Hour': 3, 'Vivid Sunset': 1 } },
      ...
      { id: 'q5d', label: 'Soft twilight',                 photo: null, gradient: 'linear-gradient(135deg, #ede9ff 0%, #5070c8 100%)', scores: { 'Dream State': 2, 'Blush Hour': 1, 'Golden Hour': 1 } },
      ...
      { id: 'q5f', label: '2AM, lamp in the dark',         photo: null, gradient: 'linear-gradient(135deg, #0a0802 0%, #e09828 100%)', scores: { 'Dark Academia': 2, 'Candlelit Cozy Evening': 3, 'Studio Dark': 1 } },
    ],
  },
  {
    id: 'q6',
    ...
    answers: [
      { id: 'q6a', label: 'Warm and welcoming',             photo: null, gradient: 'linear-gradient(135deg, #c8e8c0 0%, #389848 100%)', scores: { 'Greenhouse': 2, 'Bright Day': 1, 'Vivid Sunset': 1, 'Blush Hour': 1 } },
      ...
      { id: 'q6d', label: 'Whimsical and magical',           photo: null, gradient: 'linear-gradient(135deg, #ede9ff 0%, #7a48cc 100%)', scores: { 'Dream State': 3, 'Blush Hour': 1, 'Neon Nights': 1 } },
  ...
  },
  {
    ...
    text: 'Your element.',
    answers: [
      { id: 'q7a', label: 'Fire — passion and warmth',       photo: null, gradient: 'linear-gradient(135deg, #fda020 0%, #c83820 100%)', scores: { 'Golden Hour': 1, 'Vivid Sunset': 1, 'Candlelit Cozy Evening': 1 } },
      { id: 'q7b', label: 'Earth — grounding and growth',    photo: null, gradient: 'linear-gradient(135deg, #c8e8a0 0%, #389848 100%)', scores: { 'Greenhouse': 1, 'Blush Hour': 1, 'Vivid Sunset': 1 } },
      ...
      { id: 'q7e', label: 'Wood — growth and creativity',    photo: null, gradient: 'linear-gradient(135deg, #e8f0c8 0%, #3a7a4a 100%)', scores: { 'Greenhouse': 1, 'Bright Day': 1, 'Blush Hour': 1 } },
    ],
  },
]

const MOOD_ORDER = [
  'Golden Hour', 'Bright Day', 'Vivid Sunset', "Ember's Sunrise", 'Candlelit Cozy Evening',
  'Moonlight', 'Northern Lights', 'Dark Academia', 'Blush Hour',
  'Coastal Morning', 'Dream State', 'Neon Nights', 'Greenhouse',
  'Studio', 'Studio Dark',
]
