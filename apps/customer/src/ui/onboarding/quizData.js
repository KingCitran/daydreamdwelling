...
export const QUESTIONS = [
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'q3c', label: 'Warm and cradled',            photo: null, gradient: 'linear-gradient(135deg, #201008 0%, #d4882a 100%)', scores: { 'Vivid Sunset': 3, 'Candlelit Cozy Evening': 2, 'Cottagecore Dawn': 1 } },
  ...
  },
  {
    ...
    answers: [
      { id: 'q6a', label: 'Warm and welcoming',             photo: null, gradient: 'linear-gradient(135deg, #c8e8c0 0%, #389848 100%)', scores: { 'Greenhouse': 2, 'Bright Day': 1, 'Vivid Sunset': 1, 'Cottagecore Dawn': 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'q7b', label: 'Earth — grounding and growth',    photo: null, gradient: 'linear-gradient(135deg, #c8e8a0 0%, #389848 100%)', scores: { 'Greenhouse': 1, 'Cottagecore Dawn': 1, 'Vivid Sunset': 1 } },
...
const MOOD_ORDER = [
  ...
  'Moonlight', 'Northern Lights', 'Dark Academia', 'Cottagecore Dawn',
