...
export default function TermsPage({ onBack }) {
  ...
  const s = {
    ...
    h1: { fontFamily: "'Young Serif', Georgia, serif", fontSize: 32, fontWeight: 500, margin: '0 0 8px' },
    h2: { fontFamily: "'Young Serif', Georgia, serif", fontSize: 22, fontWeight: 500, margin: '32px 0 12px' },
