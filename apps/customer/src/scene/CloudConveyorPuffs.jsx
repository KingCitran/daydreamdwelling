  ...
  return (
    <div style={{
      ...
      {initial.map((s, idx) => {
        ...
        // same pipeline so the shape inherits the mood gradient. The design
        // team's v2 handoff provides a per-mood `eggTintGradient` whose
        // lightness range is compressed (top stops pulled down, bottom stops
        // pulled up, mid saturation preserved) — that's what stops the
        // Easter-egg shapes from looking both blown-out at the highlight and
        // crushed at the shadow vs. their neighbors.
